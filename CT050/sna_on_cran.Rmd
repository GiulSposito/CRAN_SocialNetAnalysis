...
A rede do componente 33 já é bem mais desacoplada, de menor densidade, é possível visualizar os autores mais bem "relacionados" e os autores que atuam com "pontes" entre os diversos nós na estrutura. Isso é reflexo de quando o autor trabalha em momentos diferentes com outros grupos de autores.
...
O componente 6 tem uma estrutura mais acoplada, com uma densidade de 0,26, intermediária entre a 30 e 33, é possível observar grupos que trabalham juntos e grande autor central conectando os subgrupos.
